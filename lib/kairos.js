...
async function callKairos(data) {
    ...
    console.log('askfbsdfbdbfjabskbfgjbgskjgbsjdkgbsjkdgbsjkbjksgbsjk/n/n/n');
    console.log(recognized);
    let subject;
    let detected;
...
async function detect({
    ...
    let emotions = await getEmotions(image);
    let recognized = response.data;
    return { recognized, emotions };
};
