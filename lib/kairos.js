...
//recognize();
listAllGalleries().then(console.log);
//viewGallery();
...
//iewGallery(data2).then(console.log);
//removeAllFaces();
...
async function listAllGalleries() {
    let response;
    try {
        response = await axios.post('https://api.kairos.com/gallery/list_all');
    } catch (error) {
        console.log('Oh No! Error!');
        console.log(error)
    }
...
async function viewGallery(data) {
    ...
    try {
        response = await axios.post('https://api.kairos.com/gallery/view', {
            gallery_name
        });
    } catch (e) {
        console.log('Oh No! Error!');
...
async function removeFace(subject_id) {
    let response;
    try {
        response = await axios.post('https://api.kairos.com/gallery/remove_subject', {
            gallery_name: data2.gallery_name,
...
async function detect(data) {
    ...
    try {
        response = await axios.post('https://api.kairos.com/detect', {
            image: data
        })
    } catch (e) {
        console.log('Oh No! Error!');
